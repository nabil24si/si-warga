                    ...
                    <form method="POST" action="{{ route('pengumuman.store') }}">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <textarea id="konten" name="konten" rows="6" class="block mt-1 w-full border-gray-300 focus:border-blue-900 focus:ring focus:ring-blue-900 focus:ring-opacity-50 rounded-md shadow-sm" required>{{ old('konten') }}</textarea>
                                <x-input-error :messages="$errors->get('konten')" class="mt-2" />
                            </div>

                            <div class="block">
                                <label for="is_active" class="inline-flex items-center">
                                    <input id="is_active" type="checkbox" class="rounded border-gray-300 text-blue-900 shadow-sm focus:ring-blue-900" name="is_active" value="1" {{ old('is_active', true) ? 'checked' : '' }}>
