                    ...
                    <form method="POST" action="{{ route('keuangan.store') }}">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <div class="mt-2 space-x-4">
                                    <label class="inline-flex items-center">
                                        <input type="radio" class="form-radio text-slate-900 border-gray-300 focus:ring-slate-900" name="jenis_transaksi" value="pemasukan" {{ old('jenis_transaksi') === 'pemasukan' ? 'checked' : '' }} required>
                                        <span class="ml-2 text-gray-700">Pemasukan</span>
                                    </label>
                                    <label class="inline-flex items-center">
                                        <input type="radio" class="form-radio text-slate-900 border-gray-300 focus:ring-slate-900" name="jenis_transaksi" value="pengeluaran" {{ old('jenis_transaksi') === 'pengeluaran' ? 'checked' : '' }} required>
                            ...
                            <div>
                                ...
                                <x-text-input id="kategori" class="block mt-1 w-full" type="text" name="kategori" :value="old('kategori')" placeholder="Misal: Iuran Bulanan, Perbaikan Jalan, dll" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="nominal" class="block mt-1 w-full" type="number" min="0" step="1" name="nominal" :value="old('nominal')" required />
                            ...
                            <div>
                                ...
                                <textarea id="keterangan" name="keterangan" rows="3" class="block mt-1 w-full border-gray-300 focus:border-blue-900 focus:ring focus:ring-blue-900 focus:ring-opacity-50 rounded-md shadow-sm">{{ old('keterangan') }}</textarea>
