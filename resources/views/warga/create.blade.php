                    ...
                    <form method="POST" action="{{ route('warga.store') }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="no_kk" class="block mt-1 w-full" type="text" name="no_kk" :value="old('no_kk')" required maxlength="16" />
                            ...
                            <div>
                                ...
                                <x-text-input id="rt_number" class="block mt-1 w-full" type="text" name="rt_number" :value="old('rt_number')" required />
